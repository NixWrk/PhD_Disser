...
masks={ch:np.asarray(nib.load(root/f'phase00_candidate_v02/{ch}_HU190_boundary+0mm.nii.gz').dataobj)>0 for ch in ['LV','RV','LA','RA']}
...
for start in [14,22,30,38]:
 ...
 fig.savefig(root/f'phase00_candidates_v02_{start}.jpg',dpi=125,pil_kwargs={'quality':90});plt.close(fig)
