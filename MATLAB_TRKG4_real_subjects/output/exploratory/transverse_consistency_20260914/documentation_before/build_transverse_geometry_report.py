...
def build():
    ...
    **Положение сборки при переносе геометрических условий.** расстояние между этим центром и позой, использованной в прежних расчётах 20.13–20.14 и ранее присланном срезе, составляет **64,27 мм**. Поэтому численные геометрические характеристики и объёмные модели в 20.16 построены отдельно для выбранного центра C01. Значения толщины и ранжирование моделей из прежней постановки сюда не переносятся.
