...
где бин однороден, ошибка составляет `0.17 мм`. Поэтому разрешение карты выбирается
протоколом W2 в spine-anchored цилиндрической системе координат. Разбор Gate 2 показал,
...
18. [Аудит текущего notebook](docs/NOTEBOOK_AUDIT.md)
19. [Правила данных и приватности](docs/DATA_PRIVACY.md)
