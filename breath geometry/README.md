...
двигаться вместе с тканью, и была заморожена рёберная система координат. Её preflight
провален `1/10`: у 8 из 10 субъектов число рёбер расходится между фазами, то есть
индексация уезжает — карта `Δh` не производилась. Разбор Gate 2 показал,
...
18. [Рёберная и позвоночная системы координат R1](docs/WALL_DUAL_FRAME_R1.md)
19. [Аудит текущего notebook](docs/NOTEBOOK_AUDIT.md)
20. [Правила данных и приватности](docs/DATA_PRIVACY.md)
