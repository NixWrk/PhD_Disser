...
- Карта `Δh` в любой системе координат: R1 preflight прошёл `1/10`, вычисление
  остановлено до неё (`D-049`). Доминирующий отказ — расхождение числа рёбер между
  фазами у 8 из 10, то есть именно сдвиг индексации, который опаснее шума.
