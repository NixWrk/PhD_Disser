...
Исторический S1.0 batch прошёл frozen synthetic gate только у 1/3 вариантов, но затем в
ground truth phantom v2.0 обнаружена осевая сингулярность. Исправленный v2.1 зафиксирован,
его повтор ещё не завершён. Поэтому real-pair перезапуск S1.0
