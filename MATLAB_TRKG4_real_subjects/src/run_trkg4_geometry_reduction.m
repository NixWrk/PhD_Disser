...
identity.physics=struct('electrode_area_mm2',cfg.electrode_area,'contact_ohm_m2',cfg.z_contact,'current_ampere',cfg.current_ampere);
identity.runtime=version;
helpers={'trkg4_config','trkg4_subject_registry','trkg4_scale_fmdl_to_si','electrode_faces_by_area','electrode_patch_context','system_mat_fields','calc_system_mat'};
for hi=1:numel(helpers)
 identity.helper_sources.(helpers{hi})=trkg4_file_sha256(which(helpers{hi}));
end
