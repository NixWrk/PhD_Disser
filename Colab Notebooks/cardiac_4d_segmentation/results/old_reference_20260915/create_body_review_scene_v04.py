...
phase=work['phases'][0]
out=root/'body_review_v04/slicer';out.mkdir(exist_ok=False)
...
records=[]
for label,folder,color in [('LV','sequence02_phase00_LV_body_v04',(0.2,1.,.44)),('RV','sequence02_phase00_RV_body_v02',(0.,.79,1.))]:
