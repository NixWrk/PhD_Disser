...
![Рисунок 1. Синтетический эллипсоид и сфера равного объёма](attachment:figure_01_geometry.png)
...
![Рисунок 2. Сравнение критериев эквивалентного радиуса](attachment:figure_02_criteria.png)
...
![Рисунок 3. Одинаковый базовый уровень и разные производные](attachment:figure_05_equal_baseline.png)
...
![Рисунок 4. Строго синтетические Δc_x(τ), V(τ), r(τ)](attachment:figure_03_dynamic.png)
...
![Рисунок 5. Контрольная последовательность геометрий и электрических откликов](attachment:figure_04_decomposition.png)
...
![Рисунок 6. Схема разбиения обучения и проверки](attachment:figure_06_validation.png)
