...
rv=np.asarray(nib.load(root/'agent_drafts/sequence02_phase00_RV_body_v04/RV_visible_body_agent_HU190.nii.gz').dataobj).astype(bool)
out=root/'body_review_v06';out.mkdir(exist_ok=True)
