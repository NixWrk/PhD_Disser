...
- До вычисления заморожен W1 — бюджет неопределённости профиля стенки. Он измеряет
  разброс субъектного числа внутри одной фазы под пятью семействами возмущений
  (границы тела и воздуха, окно жир/мышца, сдвиг сетки сэмплирования, субвоксельный
  jitter) и ничего не сравнивает между фазами. Пороги `1.0/2.5 мм` заморожены;
  `2.5 мм` — шаг по z COPDgene, единственного набора со стенкой в FOV. Протокол —
