...
- Классический elastix baseline на `copd1` улучшает mean expert TRE с 26.33 до 15.30 мм и
  Dice лёгких с 0.717 до 0.938 без folding, но **не проходит Gate 1**: TRE намного выше
  2 мм, TRE p95 29.81 мм и surface p95 9.04 мм.
...
1. Прогнать и зафиксировать subject-level benchmark по всем 10 COPDgene и 3 LungCT с
   независимыми landmarks; текущий `copd1` уже показывает, что простой elastix недостаточен.
