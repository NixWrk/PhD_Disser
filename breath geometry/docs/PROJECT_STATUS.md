...
1. Интегрировать ConvexAdam как следующий registration-кандидат, выбирать параметры
   только на LungCT без expert landmarks и сравнить зафиксированную конфигурацию с
